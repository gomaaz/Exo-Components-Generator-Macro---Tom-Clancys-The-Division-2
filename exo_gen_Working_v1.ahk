...
############# USE AT YOUR OWN RISK ################
    ...
    Exo Flow Macro V0.1 - Read carefully!
...
1. You need "Ultimate Edition" with Year One Pass
...
5. Place the latest outer-right agent in the safe house "the shop"
6. Set inventory sorting to "Recent" (clock icon)
7. Start the script (F2) with a blank agent slot selected on the main agent selection screen
